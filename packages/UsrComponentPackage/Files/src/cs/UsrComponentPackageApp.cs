...
namespace UsrComponentPackageApp {

	/// <summary>
	/// This is a class that provides access to the application services.
	/// This is the MAIN entry point into the UsrComponentPackageApp package.
	/// </summary>
	public sealed class UsrComponentPackageApp {

		#region Fields: Private

		private static Lazy<UsrComponentPackageApp> _instance = new Lazy<UsrComponentPackageApp>(() => new UsrComponentPackageApp());
		...
		public static UsrComponentPackageApp Instance => _instance.Value;
		...
		/// </summary>
		/// <returns></returns>
		internal UsrComponentPackageApp Reset(){
			_serviceProvider.Value?.Dispose();
			_instance = null;
			_instance = new Lazy<UsrComponentPackageApp>(() => new UsrComponentPackageApp());
		...
		private UsrComponentPackageApp() { }
	}
}
